...
PageBook
  ...
  h5 Ein overtydd ateist
  p Arnulf Øverland var alltid krass i kritikken når han gjekk til åtak på forhold han ikkje kunne godta. Han var overtydd ateist og reiste landet rundt med det polemiske foredraget 
    a(href='http://virksommeord.no/tale/387/' target='_blank') «Kristendommen – den tiende landeplage»
    | . I 1933 vart han tiltalt etter blasfemiparagrafen på grunn av dette foredraget. Øverland måtte møte i retten, men vart frikjend med éi stemmes overvekt.
  
  h5 Riksmålsmann
  p I 1938 kom det ei omfattande rettskrivingsreform som skulle føre bokmål og nynorsk nærare kvarandre. Denne reforma var Øverland sterkt imot. Som formann i Riksmålsforbundet frå 1947 til 1956 var han mellom dei fremste i kampen mot den statlege språkpolitikken. Han kunne vere ein sterkt usakleg debattant.
  
  h5 Antimodernist
  p Øverland hadde heller ikkje noko til overs for modernismen, verken i biletkunsten eller i litteraturen. Alt i 1920-åra hadde han skrive polemiske artiklar om Picasso og andre kunstnarar som prøvde ut eit nytt formspråk. I 1953 drog han på turné landet rundt med foredraget «Tungetale fra parnasset», der han særleg polemiserer mot modernistisk lyrikk, som han kallar «rabbel og snikksnakk».
  
  h5 Endra syn på kommunismen
  p Øverland var ein uredd mann med klare haldningar, som han gjerne stod inne for heile livet. Men han endra syn på kommunismen mot slutten av 1930-åra. Moskvaprosessane (1936–1938), ein utreinskingsaksjon der Stalin brutalt fjerna mange framståande medlemmer av det sovjetiske kommunistpartiet, fekk Øverland til å melde seg ut av det norske kommunistpartiet i 1937.
  ...
  p Det er ein dødsdømd fange som taler i diktet. Han har talt makthavarane imot og er dømd til avretting. I denne situasjonen høyrer diktaren kva den dødsdømde har å seie:
  ...
  p Lesaren skal vekkjast og forstå kor stor urett uskuldige må lide under eit fascistisk styre. Den dødsdømde oppmodar oss til å gjere noko med denne uretten: 
  ...
  p Dette er eit rop om hjelp frå ein fange i ein fortvilt situasjon. Men det er lett å fortrengje slik plagsam kunnskap når overgrepa skjer i det skjulte. Og dersom det krevst at ein må ofre eigne gode for å hjelpe, er mange freista til å «gløyme» og fråskrive seg ansvaret for uretten som skjer: 
  ...
  h3 Bibelske allusjonar
  p Øverland er kjend for å bruke bibelske allusjonar i dikta sine. I «Du må ikke sove» heiter det:
  ...
  figure.col.col12
   img(src='./Den-rode-front_Bilde-fra-konsentrasjonsleir-under-Bibelske-allusjoner.jpg' alt='Ei gruppe fangar marsjerer bak eit piggtrådgjerde i vinterlandskap. Foto')
  ...
  p Mot slutten av diktet gir den dødsdømde fangen uttrykk for si idealistiske tru på fred, ei tru som er gjord til skamme og som verkar fånyttes:
