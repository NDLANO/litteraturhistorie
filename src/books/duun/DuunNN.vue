...
PageBook
  ...
  p Studietida gav inspirasjon til å skrive, og han brukte eit landsmål med sterke innslag av namdalsdialekt. Duun meinte han måtte bruke heimespråket, det språket som folket hans talte, dersom han skulle dikte med truverde.
  ...
  p Vi blir kjende med menneska i øysamfunnet, mellom anna Helmer, som tek ansvar for folk rundt seg, og den mistruiske Ludvig, som hatar livet og er negativ til det meste. Når katastrofen kjem, får vi sjå kven som greier seg og overlever av alle dei som bur på øya: Det er dei som har tru på at det går an å leve i fellesskap, og som står solidariske med kvarandre. Dei som vantar denne solidariteten og har mistru til kvarandre, går under.

  h3 Det gode i mennesket
  p Hovudgrunnen til at Olav Duun var høgt akta i samtida, er nok at han sette søkjelyset på eit grunnleggjande mellommenneskeleg tema: Kva er det som gjer oss til gode menneske? Det menneskesynet Duun forfektar, går att som ein raud tråd i heile forfattarskapen.

  p Kampen mellom gode og vonde makter er på mange måtar hovudemnet i Duuns forfattarskap: På kva side står vi i kampen mellom det gode og det vonde? Utnyttar vi dei vonde maktene til å skaffe oss makt over andre? Eller kjempar vi imot det vonde og med det gode for å stå jamsides dei som treng hjelp?
  ...
  p Det vonde er altså inga universell makt, men snarare noko historisk og konkret. Derfor kan vondskapen også overvinnast. I uvêrsnatta ute på Øyvære er det livskreftene som sigrar, og dei tvingar menneska saman i ein nødvendig lagnadsfellesskap. 
