...
PageBook
  ...
  figure.col.col12
    img(src='./Krag_Det_eksotiske_og_fremmede.jpg' alt='Kvinne og mann omfavner og kjærtegner hverandre. Maleri')
    figcaption
      em Kysset 
  ...
  img.col.col12(src='./Digte_Forste-bilde-under-Inspirasjon-utenfra-–-dekadansedikterne.jpg' alt='Mann i bar overkropp sitter ansikt til ansikt med en gepard med menneskehode. Kollasj')
  .clear
  ...
  figure.col.col4.left-image.mt5
    img(src='./Krag_Symbolismen.jpg' alt='I forgrunnen en person står på en bro og holder seg for ørene. To personer som silhuetter i bakgrunnen. Et abstrakt kystlandsskap i solnedgang. Maleri')
    figcaption
      em Skrik 
  ...
  p De symbolistiske lyrikerne la stor vekt på musikalske virkemidler som klanger, rim og rytme, men de brukte ikke nødvendigvis faste rimmønstre. Den ytre formen skulle sammen med ordene skape mening i teksten. Både i «Fandango» og «Der skreg en fugl» viser Krag hvor dyktig han er til å utnytte form, klang og rytme slik at de både utdyper og forsterker det som blir sagt med ord. 

  h3 Sørlandsforfatteren Krag 
  p Etter at Krag hadde bodd flere år i hovedstaden og i København, søkte han etter hvert mer mot det hjemlige i skrivingen sin, og det var landsdelen, naturen og folket som nå var motiv for diktningen. Personene han tegnet, levde i harmoni både med seg selv og med naturen de var omgitt av. 
  ...
  figure.col.col6.right-image
   img(src='./Digte_Morgen-i-Ny-Hellesund.jpg' alt='Kystlandskap med person i robåt i forgrunnen. Flere øyer danner et sund i bakgrunnen. Maleri')
  ...
  p Vennene kaller plassen en fattigmannsplass på «en gråstein i sjøen», men dikteren sier: 
  ...
  //Medieinnhold: Beholde bilder og opplesning av lyd
