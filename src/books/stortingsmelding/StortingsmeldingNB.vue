...
PageBook(:showAuthor="false")
  ...
  p Å sette opp en norm for skriftspråket vil si å lage regler for hvordan vi skal stave og bøye ord. Ordet norm betyr rettesnor, og språknormering blir altså et begrep for arbeidet med å utvikle og endre skriftspråket. 
  ...
  p Da en på 1800-tallet diskuterte hvordan en kunne skape et norsk skriftspråk, var nettopp valget av normgrunnlag et viktig spørsmål. Ivar Aasen (1813–1896) ville lage et skriftspråk basert på talemålet i bygdedialektene, mens Knud Knudsen (1812–1895) ville tilpasse det danske skriftspråket til den såkalte dannede dagligtale, et standardisert talemål som ble snakket av en viss gruppe i samfunnet. 

  h5 Ortofoni 
  p Når vi gjør om lyd til skrift, må vi avgjøre hvilket system vi skal gå etter. I Norge har vi sterk tradisjon for det ortofone prinsippet, det vil si at hver lyd i talen skal svare til ett og samme tegn i skriften. 
  ...
  p Purisme, det å finne eller lage hjemlige avløserord i stedet for å ta inn fremmedord i språket, kan også plasseres i denne kategorien. Noen eksempler på ferske avløserord i norsk er vevsansvarlig, verdensveven, nettsted og nettside.  
  ...
  h5 1907 
  p 1907-reformen førte til at riksmålet ikke lenger var dansk, men gjenspeilte den såkalte dannede dagligtale. Det var ikke nødvendig med særlig omfattende endringer i skriftnormalen for å få til denne tilpasningen, for den dannede dagligtale var i utgangspunktet kraftig påvirket av dansk. Dessuten var det de øvre samfunnslagene som brukte dette standardtalemålet, og de var selvsagt fornøyd med å få et skriftspråk som fungerte godt for dem selv. 
  
  h5 1917 
  p Med 1917-reformen ble det åpnet for flere folkelige former i skriftnormalen. Mens en før bare kunne skrive solen og boken, ble det nå valgfritt å bruke a-ending i hunkjønnsord: sola, boka. Det ble også lov til å skrive kasta og sparka i stedet for kastet og sparket. Og mens en før måtte skrive sten, røk og løs, kunne en nå velge former med diftong i enkelte ord: stein, røik, laus. Gamle og nye former ble sidestilt, men de fleste fortsatte likevel å skrive solen, kastet og sten. 
  ...
  h5 1917 
  p Fram til 1917 var bøyningsformer som soli og husi eneformer. Nå ble det også mulig å skrive sola og husa. Og der det før måtte hete ei visa – fleire visor – alle visone, kunne en nå også velge ei vise – fleire viser – alle visene. Infinitivsformer på -e ble sidestilt med de tradisjonelle formene på -a: å leve eller å leva. Dessuten ble presensformer som biter og ligger tillatt ved siden av bit og ligg. Til og med formen je kom med i 1917-normalen, i tillegg til eg. Gjennom disse endringene ble landsmålet et aktuelt alternativ også for dem som snakket østlandsdialekter. 
  ...
  p Nå ble -a innført som hovedform i bestemt form entall av hunkjønnsord: sola, døra, og i bestemt form flertall av intetkjønnsord: husa, fjella. I-formene (soli, fjelli) ble nå sideformer, det vil si at de ikke kunne brukes i lærebøker og i administrasjonen. Også flertallsendingen -or i ord som gator og visor ble klammeform fra 1938. Pronomenformen je falt derimot ut igjen, mens infinitiv på -e ble sideform. 
  ...
  p I 1951 vedtok Stortinget å opprette ei ny nemnd som skulle utarbeide en ny læreboknormal. Lærebøkene skulle få en moderat språkform som verken var helt konservativ eller helt radikal. Norsk språknemnd begynte arbeidet sitt i 1952, og i 1959 var den nye læreboknormalen klar. 
  ...
  p Språknormering er likevel fortsatt en statlig oppgave i Norge. I 1972 ble Norsk språkråd stiftet som et rådgivende organ. Rådet endret navn til Språkrådet i 2005. 
