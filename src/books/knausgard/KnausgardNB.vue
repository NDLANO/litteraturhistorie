...
PageBook
  ...
  figure.col.col6.left-image.mt5
    img(src='./knausgaard_Portrett1.jpg' alt='Portrett av middelaldrende mann med halvlangt hår og skjegg. Foto')
    figcaption Foto: Daniel Nilsson / TT / Scanpix
    
  p Karl Ove Knausgård (1968– ) debuterte i 1998 med romanen 
    em Ute av verden
    | . For denne boka fikk han som første debutant noensinne den prestisjetunge Kritikerprisen. Ni år seinere kom 
    em En tid for alt
    | . Romanene har samme hovedkarakter – Henrik Vankel, og da Knausgård i 2009 gav ut første bind i Min kamp-serien, så flere på dette som den tredje boka i serien om Henrik Vankel. Forskjellen var at forfatteren Karl Ove Knausgård trådte inn i Henrik Vankels sted. Grensene mellom fiksjon og virkelighet ble utydelige – og med ett var Karl Ove Knausgård den mest debatterte og omtalte norske samtidsforfatteren. 

  p I det ambisiøse seksbindsverket 
    em Min kamp 
    | (2009–2011) skriver Karl Ove Knausgård svært utleverende og ærlig om sitt eget liv. Han forteller om hendinger fra oppveksten, han bretter ut sine to ekteskap, og han skriver nærgående om forholdet til sine barn og sin avdøde far. Knausgård insisterer på å kalle utgivelsene romaner, selv om de helt klart har en biografisk innfallsvinkel. 

  p Romanserien vakte sterke reaksjoner i den norske offentligheten. Knausgårds slekt og hans ekskone har reagert på å bli gjort om til romanfigurer – figurer helt prisgitt Knausgårds blikk og penn. Min kamp-prosjektet har blitt stemplet som «uetisk judaslitteratur», noe som synliggjør hva som kan skje når skillet mellom fiksjon og virkelighet utfordres. 

  p Knausgård vokste opp i Arendal og Kristiansand, men bor nå i Malmö, Sverige. Han har skrevet en rekke fagessays om litteratur og var i en periode medredaktør i litteraturtidsskriftet 
    em Vagant
    | . Knausgård har mottatt flere priser for forfatterskapet sitt. I tillegg til Kritikerprisen i 1998 fikk han i 2009 Brageprisen for 
    em Min kamp 1
    | . To ganger har han også mottatt både P2-lytternes romanpris og Sørlandets litteraturpris. 
  ...
  img.col.col6.right-image.mt5(src='./knausgaard_Min_kamp1.jpg' alt='En mengde bokomslag med tittelen Min Kamp, nummerert fra 1 til 6. Foto')
  p I 
    em Min kamp 
    | gjenforteller Knausgård mange av historiene fra de to forrige romanene. Henrik Vankel erstattes av romankarakteren Karl Ove Knausgård, og historiene om han settes inn i en biografisk kontekst, altså forfatteren Karl Ove Knausgårds livshistorie. Dette skiftet i perspektiv er helt klart et risikoprosjekt – gjenfortellingene kan «trøtte» leserne av forfatterskapet hans. Samtidig bidrar det til en spenning i tekstene hans; hvor mye er basert på selvopplevde hendelser, og hvor mye er ren fiksjon? 

  p Også innad i 
    em Min kamp
    | -serien gjenforteller og gjentar Knausgård samme historier og episoder – med enkelte nyanseforskjeller og endringer. Gjentakelsene bidrar derfor til å problematisere både virkelighetsperspektivet og sannhetsgraden i tekstene hans. Når de ulike gjenfortellingene ofte er litt forskjellige, blir minnene og fortida frigjort fra virkeligheten. 

  figure.col.col12
    img(src='./knausgaard_Min_kamp2.jpg' alt='Bygård med butikker på gateplan, bussstopp og trær i forgrunnen. Foto')
  ...
  figure.col.col6.right-image.mt5
    img(src='./knausgaard_Min_kamp3.jpg' alt='Kvinne sitter på en hagestol foran et hvitt hus. Foto')
  ...
  p Enkelte kritikere har sammenliknet Knausgårds skrivestil med barokkens idealer om detaljrikdom – alt skal skildres så detaljert og nøyaktig som mulig. I 
    em Min Kamp 
    | er det lange beskrivelser av hvordan Karl Ove vasker opp, lager middag, trakter kaffe eller opplever et barneselskap. Detaljrikdommen er stor, og selv om det ikke skjer så mye, driver språket og fortelleteknikken historien framover. 

  p Skrivestilen til Knausgård har mye felles med den retningen som kalles 
    em impresjonismen 
    | i malekunsten. Forfatteren maler stemninger og inntrykk med språket. I likhet med de impresjonistiske 
    em malerne 
    | er det ikke en nøyaktig avbildning av virkeligheten som er interessant, men hvilke stemninger og følelser en hendelse vekker. Denne måten å skrive på kan sammenliknes med Marcel Prousts 
    em På sporet av den tapte tid 
    | (1913–1927). Som Proust er Knausgård opptatt av hvordan følelser og refleksjoner starter med sansing og opplevelse. Det er ikke tingen i seg selv som er interessant, men følelsen den vekker hos karakteren – og hos leseren. 

  h3 Den innerste kjernen 
  ...
  figure.col.col5.left-image.mt5
    img(src='./knausgaard_Portrett2.jpg' alt='Portrett av middelaldrende mann med halvlangt hår og skjegg. Foto')
    figcaption Foto: Daniel Nilsson /  TT / Scanpix

  p Knausgårds lengsel etter å skrive er et gjennomgangstema i store deler av romanprosjektet. Vi møter han som elev på Skrivekunstakademiet i Bergen. Han  søker inspirasjon hos store forfattere som Hamsun, Ulven og Larsson, men opplever at hans forsøk på å skrive blir sett på som klisjéfylte og lite originale. Det er først når han opplever å kunne skrive om sitt indre, at det løsner for han. 
    em Min Kamp 
    | inneholder flere diskusjoner og refleksjoner omkring hva god litteratur er, og hva den bør forsøke å formidle. Gjennom disse refleksjonene setter Knausgård sitt eget prosjekt inn i en litterær sammenheng. 
  
  h3 Nåtid og fortid 

  figure.col.col6.right-image.mt5
    img(src='./knausgaard_Portrett3.jpg' alt='Portrett av middelaldrende mann med halvlangt hår og skjegg. Holder hendene i pyramideform foran ansiktet. Foto')
    figcaption Foto: © Fredrik Bjerknes / Dagsavisen / Samfoto / Scanpix
    
  p Knausgård problematiserer og undersøker forholdet mellom nåtid og fortid. I 
    em Ute av verden 
    | skriver han dette om farens dødsfall:  
  ...
  p Knausgård skriver seg inn i en tradisjon der forholdet mellom fiksjon og virkelighet problematiseres. Allerede på 1890-tallet hadde forfattere tilknyttet Kristianiabohemen som mål «å skrive sitt liv». På 1950-tallet ble Agnar Mykles (1915–1994) roman 
    em Sangen om den røde rubin 
    | (1956) trukket for retten. Selv om det i første rekke var «usedelig» innhold som førte til rettssak, var også et av ankepunktene Mykles bruk av «levende modeller». Flere personer i Mykles omgangskrets reagerte på at romankarakterene hans var lett forkledde utgaver av dem selv. 

  p Flere romanforfattere på 2000-tallet tar utgangspunkt i eller bruker bevisst biografisk materiale i sine litterære verk. I Norge har blant annet Nikolaj Frobenius (1965– ) skrevet en «løgnaktig selvbiografi» – 
    em Teori og praksis 
    | (2004) – om sin oppvekst på Rykkin – illustrert med bilder og kart fra stedene han skriver om. I Sverige har Åsa Lindeborg (1968– ) skrevet 
    em Meg eier ingen 
    | (2007), om sin oppvekst med en alkoholisert far, og våren 2011 ble danske Claus Beck-Nielsen (1963– ) frikjent for injurierende omtale av en tidligere venn i romanen 
    em Suverenen 
    | (2008). 
  ...
  figure.col.col4.left-image.mt5
    img(src='./knausgaard_Portrett4.jpg' alt='Portrett av middelaldrende mann med halvlangt hår og skjegg sett gjennom et vindu med dugg på. Foto')
    figcaption Foto: Daniel Nilsson / Scanpix

  p Knausgårds prosjekt kan også plasseres i en postmoderne medievirkelighet som preges av lek med virkelighet og reality. TV-serier som 
    em The Hills 
    | og 
    em Paradise Hotel 
    | er eksempler på at man kan leke med, og iscenesette, virkeligheten. De sprenger den tradisjonelle sjangerforståelsen og skaper en 
    em pseudovirkelighet
    | . Dette er noe den moderne mediebrukeren er godt vant til å forholde seg til – så hvorfor da ikke i en skjønnlitterær sammenheng også? 

  p Debatten i kjølvannet av 
    em Min kamp
