...
PageBook
  ...
  p I tillegg til danna daglegtale fanst det eit høgtidsspråk som vart kalla klokkardansk. Klokkardansken var ein bokstavrett norsk uttale av det danske skriftspråket, som mellom anna vart brukt i gudstenesta, i teateret og i skulen. Knudsen ville ha klokkardansken ut av både skulen og teateret.

  p Også danna daglegtale var påverka av dansk. Den danna daglegtalen hadde 
  ul
    li kkje tjukk l, denne lyden vart sett på som vulgær 
    li ikkje diftongar (ben, strøm, ø, ikkje bein, straum, øy)
    li ikkje hokjønnsbøying (en dør – døren, ikkje ei dør – døra)
    li ikkje -a i preteritum av svake verb (kastet, ikkje kasta) 
  ...
  ul
    ...
    li forenkle lange vokalar som been til ben og huus til hus 
    li erstatte bokstaven c(h) med k i lånord som consul og charakteer 
    li erstatte ph med og f i lånord frå gresk, slik at ein skulle skrive filosof og ikkje philosoph
  ...
  p Først i 1907, tolv år etter Knud Knudsens død, kom ei ny rettskriving der dei avgjerande prinsippa frå arbeidet hans låg til grunn. Etter 1907-reforma kunne riksmålet endeleg oppfattast som meir norsk enn dansk. I 1929 vedtok Stortinget at riksmål skulle få nemninga bokmål, og at landsmål skulle endre namn til nynorsk.
