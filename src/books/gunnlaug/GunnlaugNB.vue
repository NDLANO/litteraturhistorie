...
PageBook(:showAuthor="false")
  ...
  p Dermed vinner Ravn kappløpet og gifter seg med Helga. Så er striden i gang, og Gunnlaug utfordrer Ravn til holmgang, en duell som ender med at begge mister livet. Helga blir seinere gift med Torkjell Hallkjellsson, en storbonde i Borgarfjorden. «De får mange barn sammen», står det. Etter noen år blir folkene på gården rammet av en hard sykdom. Helga blir også syk og dør. Slik ender sagaen. 
  ...
  p Skildringen av forholdet mellom Gunnlaug og Helga er heller ikke detaljrik, men vi får likevel flere små hint om hva de to føler. Sagaen forteller at Helga gruer seg til giftermålet med Ravn, og at hun virker trist i bryllupet sitt. Når hun får vite at Gunnlaug er kommet hjem,  skjønner hun også at hun er blitt sveket. Hun blir så tverr og ugrei mot Ravn at han har «lite glede av samlivet med henne». 
  ...
  ul
    ...
    li at æren til familien stod på spill dersom ikke urett ble hevnet. Urett kunne rettes opp med blodhevn, bøter eller forlik. 
    li at æren måtte forsvares av menn og mot menn. Det ble regnet som æreløst å gå løs på en kvinne. 
    li at kvinner ikke selv kunne hevne, men de kunne egge mennene til strid. 
    li at omdømme og ettermæle var viktig. Et liv i skam hadde ingen verdi. 
    li at lojalitet, og det å være trofast mot slekt og venner, var viktig. 
    li at menneskene trodde på skjebnen. Døden kom den dagen skjebnen hadde bestemt. 
    li at en skulle møte skjebnen oppreist og med rak rygg. 

  //Medieinnhold: Beholde bilder. Hvordan er kvaliteten på elevproduksjonen?
