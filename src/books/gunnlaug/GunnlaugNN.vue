...
PageBook(:showAuthor="false")
  ...
  h3 Bakgrunn
  img.col.col8.mt5.right-image(src="./Soga-om-Gunnlaug-Ormstunge_Maleri-I-starten.jpg" alt="To menn står sentralt i ein ring av andre menn, mange med våpen. Illustrasjon")
  p 
  ...
  p Nokre år seinare ber Gunnlaug far sin om å få dra utanlands, og denne gongen samtykkjer faren. Men Gunnlaug vil ikkje berre reise, han vil òg ha Helga til kone når han kjem heim att. Far til Helga liker dårleg at Gunnlaug frir og skal vere borte i lang tid. Men han vil ikkje miste vennskapen med Gunnlaugs far og går med på at Gunnlaug skal få Helga dersom han skikkar seg vel og er tilbake på Island innan tre år.
  ...
  .clear
  br
  img.col.col6.mt5.left-image(src="./Soga-om-Gunnlaug-Ormstunge_Viking-under-lydklipp-med-Illuges-drom.jpg" alt="Mann med heildekkande hjelm held eit skjold framfor seg og ei øks i den andre handa. Foto")
  ...
  p Skildringa av forholdet mellom Gunnlaug og Helga er heller ikkje detaljrik, men vi får likevel fleire små hint om kva dei to føler. Soga fortel at Helga gruer seg til giftarmålet med Ravn, og at ho verkar trist i bryllaupet sitt. Når ho får vite at Gunnlaug er kommen heim, skjønner ho også at ho har vorte sviken. Ho blir så tverr og ugrei mot Ravn at han har «lite glede av samlivet med henne».
  ...
  img.col.col6.right-image.mt20(src="./Soga-om-Gunnlaug-Ormstunge_Siste-bilde.jpg" alt="To menn set opp ein påle. Mann i raud kappe dirigerer arbeidet, omgitt av kvinner og barn som ser på. Illustrasjon")
  ul
    ...
    li at æra til familien stod på spel dersom ikkje urett vart hemna. Urett kunne rettast opp med blodhemn, bøter eller forlik.
    li at æra måtte forsvarast av menn og mot menn. Det vart rekna som ærelaust å gå laus på ei kvinne.
    li at kvinner ikkje kunne hemne sjølve, men dei kunne eggje mennene til strid.
    li at omdømme og ettermæle var viktig. Eit liv i skam hadde ingen verdi.
    li at lojalitet, og det å vere trufast mot slekt og venner, var viktig.
    li at menneska trudde på lagnaden. Døden kom den dagen lagnaden hadde bestemt.
    li at ein skulle møte lagnaden oppreist og med rak rygg. 
