<template lang="pug">
PageBook
  h3 En modernistisk dikter 
  p Olav H. Hauge regnes for en av de fremste lyrikerne innenfor den modernistiske tradisjonen på 1900-tallet.  

  p Hauge debuterte i 1946 med samlingen 
    em Glør i oska
    | . De fleste dikt i denne samlingen hadde han skrevet allerede i 1920- og 1930-årene, og de var holdt i tradisjonell bundet stil med faste strofemønstre. Hauge uttrykte gjerne sinnsstemninger gjennom symbolske naturbilder, som i dette diktet: 
  ...
  h3 Fra bundet til ubundet stil 
  p I 1950-årene begynte Hauge å eksperimentere med den formen som skulle bli hans kjennetegn. Han la bort enderim og fast rytme og skrev nå kortere dikt med et mer konkret innhold. Hauge tok gjerne utgangspunkt i noe hverdagslig, som for eksempel en situasjon, en gjenstand eller et dyr. Diktet «Gjer ein annan mann ei beine» handler om en mann som vil betale for en tjeneste (ei beine) fordi han vet at han ikke kan gjengjelde tjenesten på annen måte: 
  ...
  p Den korte historien forteller noe allmenngyldig: En trenger ikke alltid betale for en tjeneste, og dersom det ikke er mulig å få gjort en motytelse – så gjer ein annan mann ei beine då. En enkel leveregel – og samtidig god hverdagsfilosofi. 

  p I den samme samlingen finner vi dette diktet med en annen leveregel: 
  ...
  figure.col.col4.left-image.mt5
    img(src='./Hauge_Portrett1.jpg' alt='Portrett av eldre mann med blomsterbukett i hendene. Foto')
  ...
  img.col.col12(src='./Hauge_Portrett2.jpg' alt='Portrett av eldre mann foran et stativ med flere mikrofoner. Foto')
  p I samlingen 
  ...
  p Det er denne enkle uttrykksmåten som er Hauges kjennemerke. Men bak den minimalistiske formen ligger det en livsvisdom og en innsikt som Hauge har evnet å nå svært mange med: 
  ...
  p Flere av diktene i samlingen 
    em Dropar i austavind 
    | er inspirert av japansk haikudiktning. Haikudiktet er kort og uten rim, og det skal sammenfatte noe om en situasjon eller en stemning. Haikudiktningen har hatt stor innvirkning på den modernistiske lyrikken. Olav H. Hauge eksperimenterte med denne formen tidlig i 1960-årene, og han inspirerte også andre norske lyrikere som Jan Erik Vold, Eldrid Lunden og Paal-Helge Haugen.

  h3 Rikt bildespråk 
  p Hauges bildespråk tar utgangspunkt i bygdeliv og natur, og det er vestlandsnaturen som kommer til syne, både konkret og symbolsk. 
  ...
  p Hauge tar i bruk enkle metaforer. Alle er hentet fra naturen eller nærmiljøet, og det er hele tida menneskelig livserfaring han prøver å si noe om. Her følger et lite
  dikt om kommunikasjon, også tydelig inspirert av haikutradisjonen: 
  ...
  blockquote
    ...
    | Ein stein til – 
    br
    | Eg må ha fleire steinar skal eg koma over. 
  ...
  .flex.flex-justify-center
    figure.col.col8
      img(src='./Hauge_Frimerke.jpg' alt='Frimerke med tekstutdrag fra et dikt. Hvite bokstaver mot en månelyst natthimmel. Foto')
      figcaption Sitatet på dette frimerket stammer fra lyrikeren Olav H. Hauge Illustrasjon: Posten Norge / Scanpix

  h3 Gartner og poet 

  figure.col.col6.right-image.mt5
    img(src='./Hauge_i_hagen.jpg' alt='Eldre mann holder i en grein fra et blomstrende frukttre. Foto')
  ...
  blockquote
    ...
    br
    | når dei stend i blom. 
    br
    | Etterpå skal me sitja i skuggen med eit glas sider, kanskje kan eg syna han 
    br
    | eit dikt – um eg finn eitt han likar. 
    br
    | Drakane som skyt yver himmelen med gift 
    br
    span(class="ml40") og røyk etter seg, 
    br
  ...
  figure.col.col6.left-image.mt5
    img(src='./Hauge_Dikteren_fra_Hardanger.jpg' alt='Svart-hvitt portrett av mann mot en bakgrunn av blomster. Foto')
  ...
  p Vi vet at livet noen ganger byr på tunge stunder, motgang og sorg. Men kan hende er det viktigere å holde fast ved drømmen om det vidunderlige enn at alle våre ønsker går i oppfyllelse?    

  //Medieinnhold: Vurdere video i starten. Beholde bilder. Lydfiler av diktopplesing. 
