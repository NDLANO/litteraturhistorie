...
PageBook
  ...
  img.col.col4.left-image.mt5(src='./Kielland_En_sann_realist.jpg' alt='Sepiatona portrett av mann med bølgete hår og stor mustasje. Knytta skjerf i halsen. Foto')
  ...
  p I 1885 søkte Bjørnson og Lie Stortinget om diktargasje for Kielland, men det enda med avslag. Avslaget vart grunngitt med at Kielland gjennom skrivinga og diktinga si var ein fare for ro og orden. Bøkene hans skapte debatt og vekte harme.

  p Kielland prøvde seg som redaktør i Stavanger Aftenblad eit års tid, men han fekk for mange uvenner og måtte gi opp. I slutten av 1880-åra utnemnde Stortinget han til borgarmeister i Stavanger, og eit par år seinare til amtmann (fylkesmann) i Romsdal. Dermed berga han privatøkonomien sin.

  
  h3 Tankar og idear i ei ny tid

  img.col.col4.left-image.mt5(src='./Kielland_Tanker_og_ideer_i_en_ny_tid.jpg' alt='Forsiden til ein trykksak med tittelen Hovedstrømninger. Foto')
  ...
  p Kielland fekk hjelp av Bjørnson til å debutere som forfattar i 1878, med einaktaren 
    em På Hjemveien
    | . Men det litterære gjennombrotet hans kom året etter med 
    em Novelletter
    | , ei samling korte, episodiske forteljingar som gjerne tok utgangspunkt i ei enkelthending eller eit tilfeldig møte.

  img.col.col12(src='./Kielland_En_stor_novellist.jpg' alt='Gruppe av kvinner og menn rundt eit spisebord. I bakgrunnen to servitørar. Illustrasjon')
  ...
  p Skrivemåten til Kielland er presis og elegant. Nokre av novellettene hans har ein munter humor, i andre er tonen meir ironisk eller satirisk, og her kjem samfunnskritikken tydelegare fram. 

  h3 Ein samfunnsrefsar
  p Alexander Kielland skreiv kritisk og sannferdig om dei fleste emna. I 1880 kom samtidsromanen 
    em Garman & Worse
    | , der han skildrar seglskutemiljøet og eit velståande handelshus i Stavanger. I romanen viser han forholdet mellom fattig og rik, og gjennom skarpe kontrastar avdekkjer han at føresetnaden for rikdommen hos nokre få gjerne er fattigdommen hos mange andre.

  p Det vekte oppsikt at ein roman med slik sterk tendens og så hard kritikk av sosiale tilhøve kom frå ein forfattar som sjølv representerte dei kondisjonerte og velståande i Stavanger. Men Kielland teikna ikkje noko heilsvart bilete av dei gamle bedriftseigarane og storkjøpmennene. Dei la òg for dagen eit stort ansvar for dei tilsette, og det kunne ein ikkje alltid seie om dei moderne kapitalistane som tok over.

  p I 1882 kom oppfølgjaren 
    em Skipper Worse
    | , som vart Kiellands største litterære suksess. Handlinga i denne romanen er lagd til 1840-åra, og boka gir ei truverdig skildring av ulike miljø i Stavanger og av ei tid i endring. Seglskutetida er snart over, og det går meir og meir mot dampdrivne skip. I denne boka kjem forfattaren med tydeleg kritikk av både statskyrkja og av religiøst hykleri og pengebegjær.
  ...
  img.col.col6.right-image.mt5(src='./Kielland_Gift1.jpg' alt='Ei gruppe skolegutar i forgrunnen vender seg til ein eldre lærar med skjegg i bakgrunnen. På veggen kart over Danmark og tavle med eit triangel. Illustrasjon')
  p 
    | I 1883 kom romanen 
    a(href="https://www.nb.no/items/7d0ada9cfdc39067ceaaf8ff90974edf?page=0&searchText=gift" target="_blank") Gift
    | . I denne boka rettar Kielland søkjelyset mot verdigrunnlaget for skule og oppseding.
  ...
  img.col.col6.right-image.mt5(src='./Kielland_Gift2.jpg' alt='Festkledde kvinner og menn står ved eit dekka spisebord. Illustrasjon')
  ...
  img.col.col6.right-image.mt5(src='./Kielland_Gift3.jpg' alt='Ein lærar står framfor ei klasse med gutar. Ein av gutane står oppreist bak pulten. Illustrasjon')
  ...
  p Også denne boka av Kielland vekte stort oppstyr og til dels sinne. I Stavanger nekta bokhandlarane endatil å selje boka fordi dei meinte ho var for ugudeleg. 
