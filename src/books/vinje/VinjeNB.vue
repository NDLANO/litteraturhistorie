...
PageBook
  ...
  img.col.col6.left-image.mt5(src='./Vinje_Journalist_og_lyriker.jpg' alt='Sepiatonet portrett av mann med mørkt hår og stort skjegg. Foto')
  ...
  p I perioden 1851–1858 var han hovedstadskorrespondent for Drammens Tidende. Han utmerket seg som en dyktig journalist. Allerede den gang var han inspirert  av Ivar Aasens arbeid. Vinje skrev dansk, men tok inn stadig flere norske ord og uttrykk i skriftspråket sitt. 

  p I 1858 startet han sin egen ukeavis, Dølen. Samtidig gikk han over til å skrive landsmål, på den tida et risikabelt prosjekt for en som ville leve av å skrive. Dølen var den første ukeavisa på landsmålet, og den kom ut med ujevne mellomrom helt fram til 1870. 
  ...
  img.col.col12(src='./Vinje_Politikk_og_folkeopplysning.jpg' alt='Eldre mann med mørkt stort skjegg lener seg mot et bord med venstre arm. Foto')
  .clear
  ...
  figure.col.col6.right-image
   img(src='./Vinje_Kritisk_journalist_med_tvisyn.jpg' alt='Mann med stort mørkt skjegg sitter ved en skrivepult. Rundt han er bøker og løse ark på golvet. Illustrasjon')
  ...
  h3 Ukeavisa Dølen 
  p Vinje ga ut ukeavisa Dølen fra 1858 og fram til han døde i 1870. Innholdet var en blanding av sakprosa og poesi, og han skrev det aller meste selv. 

  p I Dølen kunne folk lese om alt fra politikk, samferdsel, økonomi og teknologisk  utvikling til utdanning og kulturliv. Vinje hadde kunnskaper og meninger om det meste, og han elsket å utfordre leserne. Han utviklet en essayistisk skrivemåte som var helt ukjent for folk flest på den tida, full av ironi, humor, overdrivelser og med et tydelig forfatter-jeg. Noen lesere mislikte Vinjes stil og sluttet å abonnere på Dølen. Andre holdt avstand på grunn av landsmålet. 

  p Vinje kunne være hensynsløs i sine vurderinger. Blant annet omtalte han bondefortellingen «Arne» (1859) av Bjørnson på en nokså infam måte. Vinje mente at Bjørnson ga en idealisert søndagsframstilling av bøndene og bondelivet i fortellingene sine, og han syntes tida nå var inne for å gjøre seg ferdig med den nasjonalromantiske selvdyrkingen. Derfor lot han som om fortellingene var parodier på den nasjonalromantiske bondedyrkingen, selv om han var fullt klar over at Bjørnson ikke hadde hatt noen slik intensjon. 
  ...
  figure.col.col6.right-image
   img(src='./Vinje_Reporter_og_fotturist.jpg' alt='Snøflekket fjellandskap med vann i mellomgrunnen og fjelltopper i bakgrunnen. Foto')
  ...
  NdlaAudio(
    ...
    blockquote
      p 
        strong MANN:	
        br 
        | Dette diktet er åpninga på Vinjes store reiseskildring «Ferdaminne frå sumaren 1860». Boka er ei skildring av mennesker han møtte og plasser han fikk se mens han vandra til fots fra Eidsvoll til Trondheim. I dette åpningsdiktet beskriver han noen av de tankene og følelsene som melder seg ved avreisa fra hovedstaden. 
        br
        br
      p 
  ...
  p Et av kapitlene i 
    em Ferdaminni frå Sumaren 1860 
    | har tittelen “Grauten på Grut”. Vinje har gått fra Rennebu, badet i Orkla og kjenner at sulten melder seg. Han stikker innom gjestgivergården på Grut og får servert havregrøt: 

  img.col.col4.right-image.mt5(src='./Vinje_Graut_på_grut.jpg' alt='Katt ligger på et bord sammen med restene av en fisk. Kvinne holder fram et fat med graut. Illustrasjon')
  ...
  p Vinje peker på at det er fullt mulig å dyrke bygg mange steder der det nå bare vokser havre, men det krever at en veiter ut jorda slik at den blir tørrere. 

  p Etter denne mer saklige redegjørelsen kommer Vinje plutselig til å tenke på den norrøne guden Tor. 
    em Den eldre Edda 
    | forteller at også han livnærte seg av havre og sild. Det er lett å skjønne at Tor var en omtykt gud i gamle dager, synes Vinje, for han var så lik de menneskene som dyrket han, han spiste til og med det samme som de. Det eneste Tor manglet, legger han til, var humor. 

  p Hva vil Vinje med denne ironiske sammenlikningen? Vi vet at han hadde lite til overs for idealiseringen av den norske bonden og den norske væremåten, som var vanlig hos de nasjonalromantiske forfatterne på 1800-tallet. I «Grauten på Grut» prøver han å tegne et mer realistisk og troverdig bilde av menneskene i et norsk dalføre, samtidig som han stiller seg kritisk til måten jordbruket ble drevet på rundt om på bygdene. 

  h3 Vinje som lyriker 
  p Vinje skrev en del lyrikk og ga ut tre diktsamlinger: 
    em Diktsamling 
    | (1864), 
    em Storegut 
    | (1866) og 
    em Blandkorn 
    | (1867). De fleste diktene i disse samlingene var tidligere publisert i Dølen, enkelte også i 
    em Ferdaminni frå Sumaren 1860
    | . 
  ...
  img.col.col12(src='./Dolen_Bilde-av-Rondane.jpg' alt='En sti går innover i et fjellandskap. En varde med en rød T til venstre. Foto')

  p Diktet «Ved Rondane» ble først trykt i 
    em Ferdaminni frå Sumaren 1860 
    | og hører til de mest kjente. Det åpner slik: 
  ...
  p Diktet skildrer en sterk naturopplevelse. Jeg-personen kommer til å tenke på barndommen sin og kjenner glede over at fjellene og landskapet fortsatt gjør et like sterkt inntrykk på han som før. Han er blitt eldre, men han vet hvor han kommer fra, og denne vissheten gjør han trygg og glad.  
  ...
  img.col.col4.right-image.mt5(src='./Vinje_Tyteberet.jpg' alt='Ung kvinne plukker bær i et myrlandskap. Illustrasjon')
  blockquote
  ...
  p I den norske grunnloven av 1814 er ytringsfrihet nedfelt som en grunnleggende rett for alle borgere. Ytringsfriheten var en viktig forutsetning for framveksten av journalistikken. Fra midten av 1800-tallet var redaktører og journalister etablert som egne yrkesgrupper i Norge.

  p Av de avisene som ennå finnes i dag, er Adresseavisen i Trondheim den eldste (1767). Morgenbladet (1819) var den første norske dagsavisa. Den første samiske avisa, Muitalægje, kom ut i 1873. 

  p Fra midten av 1800-tallet hadde avisene funnet sin form som nyhetsmedier. Avisene var også viktige redskaper i folkeopplysningen og i den gryende politiske debatten. I 1880-årene ble de politiske partiene Høyre, Venstre og Arbeiderpartiet stiftet. Flere aviser etablerte seg som talerør for disse partiene, både nasjonalt og lokalt. I 1890 fantes det om lag 100 aviser i landet. 

  p I tida før vi fikk radio, tv og Internett, var det avisene som ga folk flest innsikt i norsk innenrikspolitikk og i det som hendte i hovedstaden. Som hovedstadskorrespondent for regionavisa Drammens Tidende hadde Vinje en viktig posisjon: 
  ...
  p Men ukebladene hadde også som mål å underholde leserne. Vikingen, fra 1862, var et vittighetsblad som inneholdt karikaturtegninger og drev harselas med aktuelle nyhetssaker. 

  p I 1877 ga den danske Allers-familien ut ukebladet Illustreret Familie-Journal, som seinere ble ukebladet Allers. Trykkvaliteten var så god at enkelte hengte bildene på stueveggen til pynt.           
