...
PageBook
  ...
  p Han debuterte som lyriker, med diktsamlingen 
    em Valfart 
    | i 1968. I 1969 kom 
    em Seremoniar
    | , også en diktsamling. Første prosaverk, 
    em Den hemmelege jubel
    | , kom i 1970, etterfulgt av novellesamlingen 
    em Fangliner 
    | (1972). Sin romandebut hadde Fløgstad med 
    em Rasmus 
    | (1974), men gjennombruddet hans som forfatter kom med 
    em Dalen Portland 
    | i 1977. Denne romanen fikk han Nordisk Råds litteraturpris for i 1978. Fløgstad er en kritikerrost forfatter som har mottatt en rekke priser for sitt forfatterskap. I tillegg til Nordisk Råds litteraturpris har han blant annet mottatt Kritikerprisen i 1980 og Brageprisen i 1998 og 2008. 

  figure.col.col6.right-image.mt5
    img(src='./flogstad_Portrett2.jpg' alt='Mann står foran et sceneteppe. Holder en figur fram mot fotografen. Foto')
  ...
  p Fløgstad har vært en kritisk stemme i norsk litteratur- og samfunnsdebatt i over 40 år. På 70-tallet var han redaksjonsmedlem i litteraturtidsskriftet 
    em Basar
    | . Forfatterskapet hans spenner vidt – fra komplekse romaner til tradisjonell krim og sakprosa. Han er også kjent for å leke med – og blande – ulike sjangre i tekstene sine. 
  ...
  p Fløgstads dikt har også blitt framført til musikk, av gruppa Vestlandsfanden. I 1993 gav Fløgstad ut 
    ...
    | 1968–1993 – dette er dikt og gjendiktninger av forfatteren. 

  p Som sakprosaforfatter har Fløgstad en allsidig produksjon. Han har skrevet  reiseskildringer og samfunnskritiske og litterære essays. 
    em Portrett av eit magisk liv
    | , fra 1988, er en biografi over dikteren Claes Gill, men også en historie om Gills dannelsesreise fra industristedet Odda til Oslos vestkant. Og både 
    em Arbeidets lys. Tungindustrien i Sauda gjennom 75 år 
    | (1990) og boka om arkitektfirmaet Snøhetta, 
    em Hus som vil meg hysa 
    | (2004), er fortellinger om et stykke norsk industri-, bedrifts-, og kulturhistorie. I essaysamlingen 
    em Loven vest for Pecos 
    | (1981) argumenterer Fløgstad for at det ikke går an å skape et klart skille mellom såkalt «høy-» og «lavkultur». 

  p At et skarpt skille mellom genuine kunstverk og kulturindustri for massen ikke finnes, er en sentral forutsetning for Fløgstad både som sakprosaforfatter og som skjønnlitterær forfatter. I de komplekse romanene sine, alle med et skrått blikk på Norge og norsk historie, har Fløgstad stort sett vært trofast mot et marxistisk grunnsyn på verden – og mot tre hovedinteresser: 
  ...
  h3 Nyere norsk historie i romanform 
  p 
    em Dalen Portland, Fyr og flamme 
    | (1980) og 
    em Kniven på strupen 
    | (1991) er eksempler på romaner om norsk historie der hele eller deler av handlingen er lagt til industristedet Lovra. Men som kritisk samfunnsanalytiker ser forfatteren ut over industrimiljøet. I Fyr og flamme går historien fram til begynnelsen på oljeeventyret – og oljeindustrien – på slutten av 70-tallet. I Kniven på strupen skriver Fløgstad om kjøpesentre og narkotikatrafikk, med et internasjonalt medie- og finansmarked som bakteppe. 

  p 
    em Det 7. klima 
    | (1986) er en skarp satirisk analyse, i form av en framtidsbiografi, av vårt moderne medie- og informasjonssamfunn. Og i 
    em Kron og mynt 
    | fra 1998 skildrer Fløgstad blant annet kunstens rolle i det postmoderne mediesamfunnet – og han skildrer et sosialdemokrati i forfall. Fløgstad har generelt et skjevt blikk på det norske velferdssamfunnet, og på et kapitalistisk forbrukersamfunn der alt reduseres til underholdning og forbruk. 

  p Romanen 
    em Grense Jakobselv 
    | (2009) skapte debatt på ulike måter. Romanens motiv og budskap – at nazismen på mange måter var et eliteprosjekt, og at mange nazister også etter krigen satt godt i ulike maktposisjoner, skapte ny debatt om krigen og oppgjøret etter den. Men enda større debatt skapte Fløgstad med sin håndtering av kilder, og Grense Jakobselv er en av de mange romanene i vår samtid som har skapt debatt om forholdet mellom fiksjon og virkelighet. Hvordan bør en fiksjonsforfatter forholde seg til sine kilder? Hva er sant – og hva er oppdiktet? Og hvordan kan man bruke fiksjonen til å si noe om virkeligheten? 

  h3 Dalen Portland

  figure.col.col12
    img(src='./flogstad_Dalen_Portland1.jpg' alt='Røyk fra industripiper fyller lufta i nærområdet. Foto')
  ...
  p Den første delen av romanen, kalt «Harde tak» er viet fortellingen om Selmer Høysand. Selmer er bondesønn, men i takt med tida får han seg jobb på fabrikken i bygda – som er eid av et stort amerikansk selskap. Selmer er førstegenerasjons industriarbeider, og han oppdager fort at han kan tjene mye mer som industriarbeider enn som bonde. Han er en lojal og arbeidsom kar, men etter hvert innser han at identiteten hans er tett knyttet til livet som bonde. Han begynner å jobbe på familiegården i fritida, stemmer på Bondepartiet, leser nynorskforfattere med røtter i bondekulturen – og deltar aktivt i bondeungdomslagets fritidstilbud. 
  ...
  figure.col.col6.right-image.mt5
    img(src='./flogstad_Sauda_smelteverk1.jpg' alt='Silhuetten av industriarbeider sees mot flammene fra smelteovner. Foto')
  ...
  figure.col.col12
    img(src='./flogstad_Sauda_smelteverk2.jpg' alt='To arbeidere staker opp en smelteovn. Foto')
    figcaption Arbeidere ved Sauda Smelteverk. Foto: © Bernt Eide / Samfoto / Scanpix

  h5 Vekslende fortellerperspektiv
  p Det er flere fortellere i 
    em Dalen Portland
    | . Fortellingen om Arnold og Selmer har en autoral, allvitende forteller. Fortelleren har større innsikter i samfunnsmekanismene som preger livet til og rundt de to, og han kan se både bakover og framover – slik at leseren kan se karakterene i perspektiv. Fortellingen om Rasmus, derimot, er stort sett fortalt av Rasmus selv, ja fortelleren gir ham ordet inne i fortellingen. Mot slutten av romanen får vi vite at Rasmus strever med å skrive sin selvbiografi. Denne biografien åpner med den samme setningen som romanen åpner med. 
    em En slik lek med vekslende fortellerperspektiv 
    | er typisk for mange av Fløgstads romaner. 

  p Et annet grep som peker ut over sosialrealismen, er de mange fantastiske episodene i fortellingen om Rasmus. Han er eneste overlevende etter en flystyrt, han blir samboer – og venter barn – med ei kvinne som skal vise seg å være halvsøstera hans, og han er ellers utstyrt med egenskaper – og en mengde flaks – som til tider virker noe urealistiske. 

  p 
    em Den magiske realismen 
    | kjennetegnes av at overnaturlige – eller fantastiske – hendelser skjer i en ellers ganske så realistisk handling. I historien om og av Rasmus finner vi mange slike eksempler. Pikareskromanen er en sjanger som oppstod i Spania på 1500-tallet. Den er ofte skrevet som en jeg-fortelling, bestående av korte episoder, og handler om en omreisende, eventyrlysten og skøyeraktig vagabond – en pícaro. På mange måter kan man lese Rasmus som en slags moderne pícaro. 

  h3 Mot et postmoderne uttrykk 

  figure.col.col4.left-image.mt5
    img(src='./flogstad_Portrett3.jpg' alt='Portrett av voksen mann med bart, halve ansiktet i skygge mot flammegul bakgrunn. Foto')
  ...
  p Et annet typisk postmoderne trekk ved flere av Fløgstads tekster er at de er 
    em metafiksjonelle
    | . På ulike måter kommenterer teksten seg selv som tekst, fortelleren kommenterer for eksempel at han skriver en fortelling. Fløgstad bruker blant annet slike fortellergrep i romanene 
    em Dalen Portland
    | , 
    em Fyr og flamme 
    | og 
    em Det 7. klima
    | . Flere har pekt på at Det 
    em 7. klima
    | , som er en kompleks og selvbevisst tekst om det postmoderne informasjonssamfunnet, er det nærmeste vi kommer en postmoderne roman i norsk 80-talls litteratur.  


//  Medieinnhold: ta ut video/lyd. Ta ut bilde av kronprinsen?   
