...
PageBook
  ...
  img.col.col4.left-image.mt5(src='./Skram_en_ekte_naturalist.jpg' alt='Svart og hvitt portrett av mørkhåret kvinne med oppsatt hår og lokker. Foto')
  ...
  p I 1882 debuterte Amalie Skram med novellen «Madam Højers Leiefolk». Dette er en fortelling om en fattig arbeiderfamilie som kastes ut av boligen sin. Også her finner vi den sterke skildringen av sosial nød som preget det meste av forfatterskapet hennes.  
  ...
  img.col.col6.right-image.mt5(src='./Skram_Ekteskap_som_tema.jpg' alt='Naken kvinne ligger med utslått hår på en benk med tepper. Hun holder hendene over hodet og ser på fotografen. Foto')

  p Fra 1885 fram til 1892 gav Amalie Skram ut fire romaner med ulykkelige ekteskap som tema. I 
    em Constance Ring 
    | (1885) skildrer hun hvordan ei ung jente går inn i et konstruert ekteskap uten å vite noe som helst om seksualitet. Dette var et emne som ingen hadde skrevet om før. I 1888 kom 
    em Lucie
    | , som handler om ei gatejente som gifter seg med en advokat. Romanen ender tragisk. Også den neste romanen, 
    em Fru Inès 
    | fra 1891, får en tragisk slutt. 
  ...
  p 
    ...
    | &nbsp;fra 1885 forteller Amalie Skram om en ung mor og barnet hennes som begge fryser i hjel en kald vinternatt på ei brygge i Kristiania. 
  ...
  figure.col.col12
   img(src='./Skram_Karens_jul.jpg' alt='To hesteekvipasjer i en bygate om vinteren. Hestene har dekke som snøen har lagt seg på. Foto')
  ...
  p 
    em Hellemyrsfolket 
    | blir regnet for et hovedverk i norsk naturalistisk dikting. Verket består av fire romaner som kom ut i tidsrommet 1887–1898. 

  figure.col.col6.right-image.mt5
   img(src='./Skram_Hellemyrsfolket.jpg' alt='Svart hvitt bilde av kunder og fiskere på et fiskemarked. En kvinne bærer en stor kurv. Foto')
  ...
  p Den første boka, 
    em Sjur Gabriel
    | , er en kort fortelling om fattigdom og hverdagsslit på et småbruk. Sjur Gabriel og kona Oline står på så godt de kan, men når presset blir for hardt, er det brennevinet og fylla som styrer dem. 

  p I bok nummer to, 
    em To Venner
    | , møter vi Oline igjen. Hverdagen hennes er hard og trist. Hun har også født mange barn og mistet mange av dem tidlig. Alt dette har satt sine spor hos Oline, som drikker for å holde ut livet på et vis. 

  p Både i 
    em To Venner 
    | og i de to neste bøkene, 
    em S.G. Myhre 
    | og 
    em Afkom
    | , følger vi generasjonene etter Sjur Gabriel og Oline, og vi ser hvordan fortida kaster skygge over alle sammen. 

  p De fire bøkene om 
    em Hellemyrsfolket 
    | forteller en trist historie om nød, under ­ trykking og menneskelig undergang. Her er ingen tro på at mennesket kan gjøre opprør for å endre sin egen livssituasjon, tvert imot: Forfatteren vil vise at familiebakgrunn og samfunnsforhold avgjør hvordan mennesket handler, tenker og føler.

  h3 Et vanskelig liv 

  img.col.col6.left-image.mt5(src='./Skram_Et_vanskelig_liv.jpg' alt='Kvinne og mann sitter på en sofa i et interiør fra 1800-tallet. Kvinnen holder begge hender på mannens kne. Illustrasjon')
  ...
  p Amalie Skram hadde et vanskelig liv. Hun slet med dårlig mental helse og var flere ganger pasient ved psykiatriske sykehus, både i Kristiania og i København. Disse oppholdene har hun skildret med kritikk og harme i to romaner med selvbiografisk form, 
    em Professor Hieronimus 
    | og 
    em Paa Sct. Jørgen 
    | (begge fra 1895). Etter det siste oppholdet på psykiatrisk sykehus tok ekteskapet med Erik Skram slutt. Fra 1901 fikk hun diktergasje av den danske staten og bodde de siste årene i København med dattera. 
