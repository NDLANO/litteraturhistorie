...
PagePeriod(
  ...
  img.col.col5.left-image(src="./Realisme_Det_moderne_gjennombruddet1.jpg" alt="Trengsel av kvinner utenfor en bygning på vinterstid. Maleri.")
  ...
  a(href="media/periods/realisme/Aapinen.pdf" target="_blank")
    figure.col.col6.right-image.mt5
      img(src='./Realisme_Utviklingen_av_det_norske_spraaket1.jpg' alt='Dobbeltside i bok med et eldre alfabet. Foto.')
      figcaption Klikk for å lese boken
  ...
  .flex.flex-justify-center
    figure.col.col4.p5
      img(src="./Realisme_Utviklingen_av_det_norske_spraaket_Aasen.jpg" alt="Portrettbilde av en mann med skjegg. Foto.")
  ...
  figure.col.col4.left-image
    img(src="./Realisme_Andre_kunstformer_Grieg.jpg" alt="Selvsikker mann med bart poserer med hendene i jakkekragen. Foto.")
