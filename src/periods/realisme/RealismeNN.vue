...
PagePeriod(
  ...
  p
    ...
    | er best kjend for å ha komponert melodien til ”Ja, vi elsker”. Han var fetter av Bjørnstjerne Bjørnson, og Nordraak tonesette fleire av tekstane hans.

  p
    strong Johan Svendsen (1840–1911)
    | levde storparten av livet i København. Han er mest kjend for romansar for fiolin og orkester. På same måten som Edvard Grieg var Svendsen inspirert av den norske folkemusikken. Han gjorde internasjonal karriere både som dirigent og som komponist.

  p
    strong Agathe Backer Grøndahl (1847–1907)
    | studerte både i Tyskland og i Italia og var ein framifrå konsertpianist. Backer Grøndahl komponerte i alt 70 verk for piano. Ho var ein nær venn av Edvard Grieg og er kjend for å ha framført musikken hans ute i Europa. 
