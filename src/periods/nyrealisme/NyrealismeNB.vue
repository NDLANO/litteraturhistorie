...
PagePeriod(
  ...
  p
    | I 1905 ble unionen med Sverige oppløst. Det hele ordnet seg på fredelig vis, etter flere års konflikt med svenskekongen Oscar 2. Det var en samlet regjering som stod bak kravet om selvstendighet, og en folkeavstemning viste at hele folket støttet regjeringen i dette kravet. 
  ...
  p
    | En annen gruppe som gradvis fikk mer makt i samfunnet, var kvinnene. De hadde vært en nokså usynlig gruppe, men i 1913 fikk de allmenn stemmerett. Også i de andre nordiske landene fikk kvinnene stemmerett rundt dette tidspunktet. Bare noen få land i verden var enda tidligere ute, blant annet New Zealand og Australia. De to første tiårene av 1900-tallet fikk kvinnene stemmerett både i USA og i de fleste europeiske land. 

  h5 Europa: ”La Belle Époque” 
  p
    | Begynnelsen av 1900-tallet var preget av sterk optimisme i hele Europa, og epoken blir omtalt som ”La Belle Époque”, det vil si ”den skjønne tida”. I Norge holdt denne optimismen seg, i alle fall til en viss grad, men i Europa ellers skjedde det en radikal endring i mentalitet og livssyn etter 1918. Under første verdenskrig ble om lag ti millioner soldater drept. I tillegg omkom rundt sju millioner sivile. I enkelte land ble en hel generasjon unge menn skadd og uføre, om de da overlevde skyttergravene. Den moderne teknologien som skulle sørge for frihet og framskritt, hadde ført til død og granatsjokk, stress og angst. 

  h5 Krise i verdensøkonomien 
  p
    | Framtidsoptimismen fikk seg også en alvorlig knekk på grunn av en krise i verdensøkonomien. Børskrakket på Wall Street i 1929 førte mange land ut i en økonomisk depresjon. Resultatet var stor arbeidsledighet, fattigdom og nød – og misnøye med myndighetene. Liberalismens ideal om det frie markedet ble etter dette revurdert, og også i USA grep staten sterkere inn i økonomi og næringsliv.  
  ...
  p
    | Tilsvarende konflikter foregikk i arbeiderpartiene i hele Vest-Europa, men Norge var det eneste landet der den revolusjonære delen av arbeiderbevegelsen fikk flertallet med seg i første omgang. Flere norske kunstnere, blant annet noen av de nyrealistiske forfatterne, var tydelig sosialistiske eller kommunistiske i sitt politiske engasjement  

  h5 En renessanse for kristendommen  
  p
    | Flere filosofer og tenkere på 1800-tallet hadde problematisert kristendommen både som livssyn og som maktfaktor. Charles Darwin (1809–1882) og Friedrich Nietzsche (1844–1900) hadde på ulike måter utfordret troen på at jorda og menneskene er skapt av Gud. Også de realistiske forfatterne i 1880-årene var sterkt kritiske til kirkens makt i samfunnet.  
  p
  ...
  p
    | En forklaring på dette er at Norge nå endelig var fritt. Unionen med Sverige var tilbakelagt, landet var ungt og friskt – og selvstendig. Norge var heller ikke med i den første verdenskrigen. I Europa førte denne krigen til død og ødeleggelse – og til sterk pessimisme. I Norge var derimot den allmenne stemningen mer optimistisk og sterkt fedrelandspatriotisk.  
  p
    | Men det var ikke bare framskrittsoptimisme som preget folket. Industrialiseringen og urbaniseringen førte til store sosiale endringer på kort tid, og mange fikk erfare skyggesidene ved moderniseringen. Enkelte forfattere valgte derfor å fordype seg i etiske problemer knyttet til de endrete samfunnsforholdene. Denne nye litterære strømningen ble kalt nyrealisme og kom til å dominere norsk litteratur helt fram mot andre verdenskrig.  
  ...
  h5 Slektsromaner 
  p
    | Forfatterne var ofte opptatt av å vise at valg kan få konsekvenser i lang tid framover, ja over flere generasjoner. Det kom derfor mange flerbindsverk, der vi følger en familie over lengre tid og gjennom flere generasjoner.  

  h5 Historiske romaner  
  p
    | En annen typisk tendens er de mange historiske romanene som nå dukket opp. Etter at landet på nytt var selvstendig, hadde folk behov for å bli mint om sin egen historie. Forfatterne la handlingen i sine tekster til forskjellige tider, til ulike steder av landet og til ulike miljøer og samfunnsklasser. 

  // * Nyrealistisk litteratur
  ...
  p
    | I denne perioden får det realistiske uttrykket sin renessanse. Målet var at kunstuttrykkene skulle være forståelige og lette å kjenne igjen. Beskrivelsene av personer og miljøer skulle være mest mulig virkelighetsnære. Det ser vi særlig i Sigrid Undsets middelalderromaner. Hun brukte mye tid på bakgrunnsundersøkelser fordi hun ville skildre samfunnet i Norge på 1300-tallet så nøyaktig og korrekt som mulig.  
  p
    | Bruken av talemål var et viktig virkemiddel når forfatterne skulle tegne realistiske miljøer og karakterer. Spesielt Olav Duun er kjent for å skrive dialogene i sine bøker på namdalsmålet.  
  p
    | Nyrealistene skrev om psykologiske mekanismer og om etiske dilemmaer som enkeltmennesket sleit med i møte med samtida. Karakterene skildres på en troverdig og nyansert måte, og den indre kampen de må kjempe, gjør at de ikke virker statiske eller flate. Nyrealismen er epoken for de store og lange fortellingene. Etter løsrivelsen fra Sverige hadde en behov for fortellinger om fortida og om utviklingen som landet hadde gjennomgått. I flerbindsverkene kunne forfatterne få fram nyanser og et samlet bilde av karakterer og miljø. Også på den måten ble fortellingene mer virkelighetsnære.  
  ...
  h5 Olav Nygard 
  p
    | Olav Nygard (1884–1924) skrev sentrallyriske dikt om de store spørsmål i livet. Han kan plasseres i en romantisk diktertradisjon. Mange av Nygards dikt formidler et romantisk og naturmytisk verdensbilde, og han var tydelig inspirert av romantiske lyrikere som Shelley, Keats og Wergeland. Nygard blir også omtalt som ”dødens dikter” fordi flere av diktene hans handler om nettopp døden. Nygards liv var preget av sykdom, og han rakk bare å gi ut fire diktsamlinger før han døde av tuberkulose, 40 år gammel. 
  ...
  h5 Rudolf Nilsen 
  p
    | Rudolf Nilsen (1901–1929) var en representant for arbeiderdiktningen i begynnelsen av århundret. Nilsen ble med i Norges Socialdemokratiske Ungdomsforbund i 1919, og i 1923 meldte han seg inn i Norges Kommunistiske Parti. Mange av diktene hans handler om arbeiderkamp og arbeidernes rettigheter, og de blir lest den dag i dag ved ulike markeringer for arbeiderbevegelsen. Nilsen skrev også kjærlighetsdikt og dikt om hjembyen sin, Oslo.  
  ...
  p
    | I 1887 vedtok Stortinget at dansk-norsk og landsmålet til Ivar Aasen skulle være likestilte målformer. Det innebar at begge skriftspråkene skulle brukes i statsadministrasjonen. I 1907 ble dessuten sidemålsstilen innført. Nå skulle elevene ikke bare lese, men også skrive på begge målformene.  
  p
    | Det dansk-norske skriftspråket var ennå så godt som dansk. Rettskrivingen lå så langt unna talemålet til de fleste at det var vanskelig å lære seg skrivemåten. Det hastet derfor med å fornorske dansk-norsken.  
  p
    | Landsmålet ble tatt i bruk i stadig flere skolekretser. I 1909 hadde 20 prosent av alle skolekretsene gått over til landsmål. Landsmålet hadde behov for fastere rettskrivingsregler, blant annet fordi forfatterne som skrev på landsmål, ikke holdt seg til den normen Ivar Aasen hadde foreslått.  
  p
    | Men den overordnete utfordringen lå i at vi hadde fått to konkurrerende skriftspråk, for det var en situasjon ingen oppfattet som ideell. Alle ønsket et norsk skriftspråk, men bare ett. Politikerne var nødt til å gripe fatt i situasjonen. I første halvdel av 1900-tallet handlet derfor språkpolitikken i Norge om hvordan en kunne få de to målformene til å møtes.  
  p
    | Hele perioden fram mot andre verdenskrig var preget av kampen for ett skriftspråk – samnorsk. I første halvdel av århundret vedtok politikerne flere språkreformer. Hensikten var å fornorske dansk-norsken, å modernisere nynorsken og framfor alt å føre de to målformene nærmere hverandre. 

  h5 1907-reformen 
  p
    | Den første offisielle reformen kom i 1907. Den gjaldt dansk-norsk og var det første skrittet mot det vi i dag kaller bokmål. Først nå ble forslagene til språkmannen Knud Knudsen gjennomført, og skriftspråket ble bedre tilpasset til norsk uttale.  
  ...
  h5 1917-reformen 
  p
    | I 1917 vedtok Stortinget en ny reform. Denne gangen gjaldt reformen begge målformer. Politikerne ønsket en fastere og mer konsekvent skrivenorm. Men samtidig fikk mange ord valgfrie skrivemåter som var like i bokmål og nynorsk. En kunne for eksempel ha a-ending i alle hunkjønnssubstantiv: Bygda ble likestilt med bygdi på landsmål og med bygden på riksmål. 1917-reformen møtte større motstand, særlig fra den konservative delen av riksmålsleiren. 
  ...
  h5 Film 
  p
    | I 1904 ble den første norske kinoen åpnet i Kristiania, og det kom straks flere. I 1911 var ca. 150 kinoer i drift på landsbasis. Filmen hadde høy status i begynnelsen, blant annet fordi ankomsten og kroningsferden til kong Haakon 7. ble filmet og vist som dokumentarfilm på kinoene. Folk over hele landet kunne da følge kongen og familien hans.  
  p
